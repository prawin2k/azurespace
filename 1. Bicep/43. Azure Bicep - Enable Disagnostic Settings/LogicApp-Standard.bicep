...
resource logicapps_diagsettings 'Microsoft.Insights/diagnosticSettings@2021-05-01-preview' = {
  ...
  properties: {
    ...
    workspaceId: resourceId('Microsoft.OperationalInsights/workspaces',pWorkspaceName)
  }
}
